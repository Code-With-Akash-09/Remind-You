...
const CreateLearnFolderForm = ({ parentId, initialData = null, className, iconClassName }) => {
    ...
    const onSubmit = async (values) => {
        ...
        if (data) {
            ...
            setLoading(false)
            toast.error("Failed to create Learn Folder")
        }
    }
...
export default CreateLearnFolderForm
