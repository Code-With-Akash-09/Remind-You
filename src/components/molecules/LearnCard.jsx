...
const LearnCard = ({ learn, global = false, className }) => {
    return (
        <>
            {
                learn.type === "folder" ? (
                    <FolderCard {...{ learn, global, className }} />
                ) : (
                    <FileCard {...{ learn, global, className }} />
                )
            }
        </>
    )
...
const FolderCard = ({ learn, global, className }) => {
    ...
    return (
        <div
            className={cn("flex flex-col aspect-[3/1.8] md:aspect-video cursor-pointer w-full border relative rounded-md bg-[url('/assets/banner-img/video-folder-bg.avif')] group bg-contain md:bg-cover bg-right md:bg-center bg-no-repeat hover:shadow-md border-amber-400 dark:border-amber-400/60 transition-all", className)}>
            <div
...
const FileCard = ({ learn, global, className }) => {
    ...
    return (
        <div className={cn("flex flex-col aspect-[3/1.8] h-full md:aspect-video cursor-pointer w-full border relative rounded-md bg-[url('/assets/banner-img/video-file-bg.avif')] group bg-contain md:bg-cover bg-right md:bg-center bg-no-repeat hover:shadow-md border-blue-400 dark:border-blue-400/60 transition-all", className)}>
            <div
                onClick={handleRedirect}
                className="flex flex-col justify-between flex-grow flex-1 border-b border-neutral-200 dark:border-neutral-700 w-full p-2 md:p-4 gap-1 md:gap-2">
                <div className="flex w-full">
