...
import { deleteLearn } from "@/actions/learn"
...
const DeleteLearn = ({ learnId, text, type, className, iconClassName }) => {
    ...
    const handleDelete = async () => {
        await deleteLearn(learnId)
            .then(result => {
                ...
                setOpen(false)
                if (pathname === `/dashboard/learns/learn/${learnId}`) router.push("/dashboard/learns")
            })
            .catch(err => {
            ...
            <Dialog open={open} onOpenChange={() => setOpen(false)}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Are you sure you want to delete this learn {type}?
                        </DialogDescription>
                    </DialogHeader>
