			...
			<div className="flex h-full w-full">
				<div className="grid grid-cols-4 h-full w-full gap-4">
					<div className="flex flex-col w-full h-full gap-4 col-span-3">
						<div className="flex flex-col w-full h-fit border bg-white  p-4 gap-2 md:gap-4 rounded-md">
						...
						<div className="flex flex-col w-full flex-grow border bg-white  p-4 gap-2 md:gap-4 rounded-md">
							<span className="text-sm font-medium">Recent Activities</span>
							<RecentActivity />
						</div>
					</div>
					<div className="flex flex-col w-full h-full border bg-white p-4 gap-4 rounded-md">
